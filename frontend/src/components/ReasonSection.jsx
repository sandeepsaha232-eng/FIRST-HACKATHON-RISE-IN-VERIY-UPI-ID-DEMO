...
const ReasonSection = forwardRef((props, ref) => {
    return (
        <section ref={ref} id="reason" className="min-h-screen w-full flex items-center justify-center bg-slate-900 relative">
            <motion.div
